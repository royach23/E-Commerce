...
async def getTransactionProducts(transaction_id: int, db):
...
async def getTransactionProductById(transaction_id: int, product_id: int, db):
...
async def createTransactionProduct(transactionProduct, db):
...
async def deleteTransactionProduct(transaction_id: int, product_id: int, db):
